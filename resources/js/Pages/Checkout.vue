...
onMounted(() => {
    stripe = Stripe(
        "pk_test_51MQxb6FUM1bSrCJHtpcAwqVdCxBGi6pPO9y2q6cUbGFWiRbxNa89av4WnO5cu8dDzO7JNj9tUIVLo16aEZ4qdeCU00fidOpT5u"
    );
    ...
    <AuthenticatedLayout>
        ...
        >
            <div class="flex items-center py-1">
                <img width="60" :src="prod.image" class="rounded-md" />
                <div class="ml-4">
...
#card-element {
    ...
    padding: 12px;
    border: 1px solid rbga(50, 50, 93, 0.1);
    height: 44px;
    width: 100%;
    background: white;
}
